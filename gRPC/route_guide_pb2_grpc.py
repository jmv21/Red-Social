...
import gRPC.route_guide_pb2 as route__guide__pb2
...
class RouteGuideStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Alive = channel.unary_unary(
                ...
                request_serializer=route__guide__pb2.Feature.SerializeToString,
        ...
        self.Find_succ = channel.unary_unary(
                ...
                request_serializer=route__guide__pb2.Idvalue.SerializeToString,
                response_deserializer=route__guide__pb2.Address.FromString,
                )
        ...
        self.Get_succ_list = channel.unary_unary(
                ...
                request_serializer=route__guide__pb2.Feature.SerializeToString,
                response_deserializer=route__guide__pb2.Address_list.FromString,
                )
        ...
        self.Get_storage = channel.unary_unary(
                ...
                request_serializer=route__guide__pb2.Address.SerializeToString,
                response_deserializer=route__guide__pb2.Storage.FromString,
                )
...
def add_RouteGuideServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Alive': grpc.unary_unary_rpc_method_handler(
                    servicer.Alive,
                    request_deserializer=route__guide__pb2.Feature.FromString,
            ...
            'Find_succ': grpc.unary_unary_rpc_method_handler(
                    servicer.Find_succ,
                    request_deserializer=route__guide__pb2.Idvalue.FromString,
                    response_serializer=route__guide__pb2.Address.SerializeToString,
            ),
            ...
            'Get_succ_list': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=route__guide__pb2.Feature.FromString,
                    response_serializer=route__guide__pb2.Address_list.SerializeToString,
            ),
            ...
            'Get_storage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=route__guide__pb2.Address.FromString,
                    response_serializer=route__guide__pb2.Storage.SerializeToString,
            ),
...
class RouteGuide(object):
    ...
    def Alive(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/Alive',
            route__guide__pb2.Feature.SerializeToString,
    ...
    def Find_succ(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/Find_succ',
            route__guide__pb2.Idvalue.SerializeToString,
            route__guide__pb2.Address.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Get_succ_list(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/Get_succ_list',
            route__guide__pb2.Feature.SerializeToString,
            route__guide__pb2.Address_list.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Rectify(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/Rectify',
            route__guide__pb2.Address.SerializeToString,
            route__guide__pb2.Feature.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Get_storage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/routeguide.RouteGuide/Get_storage',
            route__guide__pb2.Address.SerializeToString,
            route__guide__pb2.Storage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
